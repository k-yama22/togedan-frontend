          ...
          <div className='w-full max-w-md'>
            ...
            <div className='leading-loose'>
              <div className='max-w-md m-4 p-10 bg-white bg-opacity-25 rounded shadow-xl'>
                ...
                <div className='mt-2'>
                  <label className='block  text-sm text-white'>ジャンル</label>
                  <input
                    className='w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white'
                    type='text'
                    placeholder='ジャンル'
                ...
                <div className='mt-2'>
                  <label className='block  text-sm text-white'>開催場所</label>
                  <input
                    className='w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white'
                    type='text'
                    placeholder='開催場所'
                ...
                <div className='mt-2'>
                  <label className='block  text-sm text-white'>開始時刻</label>
                  <input
                    className='w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white'
                    type='time'
                    placeholder='開催時刻'
                ...
                <div className='mt-2'>
                  <label className='block  text-sm text-white'>終了時刻</label>
                  <input
                    className='w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white'
                    type='time'
                    placeholder='終了時刻'
                ...
                <div className='mt-2'>
                  <label className='block  text-sm text-white'>最大人数</label>
                  <input
                    className='w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white'
                    type='number'
                    placeholder='最大人数'
