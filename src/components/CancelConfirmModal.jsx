...
export const CancelConfirmModal = (props) => {
  ...
  return (
    <>
      <button
        className="bg-red-500 text-white active:bg-red-600 font-bold text-xs md:text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
        onClick={() => {
          setShowModal(true);
          setSModalId(id);
